...
export const projects: Project[] = [
  {
    ...
    descriptionTopicSecond: "1.Task Inbox & Monitoring: Developed a centralized interface for users to manage pending actions, including document signing, reviews, and acknowledgments. 2.Task Inbox & Monitoring: Developed a centralized interface for users to manage pending actions, including document signing, reviews, and acknowledgments. 3.Automated Routing & Workflows: Built an intelligent system for document circulation (routing) and official endorsements to ensure efficient correspondence. 4.Status Tracking: Implemented real-time tracking of document history and copies to ensure transparency in official workflows.",
    image: "/hr.jpg",
